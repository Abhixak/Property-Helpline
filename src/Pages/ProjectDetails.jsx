      ...
      <div className="!px-6 rounded-xl !py-10 max-w-6xl !mx-auto bg-white">
        ...
        {property.layoutPlan && (
          <div className="!mt-6">
            ...
            <a
              href={property.layoutPlan}
              download
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 !px-4 !py-2 bg-blue-600 text-white text-[100px] !mt-4 rounded-md hover:bg-purple-700 transition"
            >
              <AiFillFilePdf />
            </a>
          </div>
        ...
        {property.paymentPlan && (
          <div className="!mt-6">
            ...
            <a
              href={property.paymentPlan}
              download
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 !px-4 !py-2 bg-blue-600 text-white text-[100px] !mt-4 rounded-md hover:bg-yellow-600 transition"
            >
              <AiFillFilePdf />
            </a>
          </div>
